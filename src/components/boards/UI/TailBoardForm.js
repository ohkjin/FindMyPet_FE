        ...
        <div className="border-b border-gray-900/10 pb-12">
          ...
          <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
            <div className="Category sm:col-span-4">
              ...
              <div className="mt-2">
                <TailAnimalButton icon={''} text={'커뮤니티 글'} handleButton={()=>handleSelCate()} selected={false}/>
              </div>
            </div>
            ...
            <div className="Title sm:col-span-4">
              ...
              <div className="mt-2">
                <div className="px-3 flex rounded-md shadow-sm ring-1 ring-inset ring-gray-200 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                  <input
                    type="text"
                    name="title"
                    id="title"
